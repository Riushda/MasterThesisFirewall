...
def load_ruleset(nft, json_order):
    try:
        data_structure = json.loads(json_order)
...
def main():
    ...
    load_ruleset(nft, NFTABLES_RULESET_JSON)
    load_ruleset(nft, NFTABLES_RULESET_JSON_EXTRA)
    '''
