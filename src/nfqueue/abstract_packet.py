"""
This class defines the abstract data of a packet common to all application layer protocols. It contains all the
functions to parse the different layers, but also to communicate with the ProtocolDecoder.
"""
