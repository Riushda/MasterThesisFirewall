...
sudo dnf install -y make automake gcc python3-devel python3-nftables libnetfilter_queue-devel pip tmux nano
sudo pip install NetfilterQueue Pyro4 Cython transitions schedule scapy
